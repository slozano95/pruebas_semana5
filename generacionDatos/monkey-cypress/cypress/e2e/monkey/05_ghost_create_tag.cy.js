...
context('Create tag with common data', () => {
  beforeEach(() => {        
    ...
    slugTag = faker.random.alpha(191);
    descriptionTag = faker.random.alpha(510);
  })
  ...
  describe('Create new tag ghost', () => {
    ...
    it('Login', () => {
      ...
      ss("Save")
      cy.wait(1000);      
      cy.get('p[class="response"]').should('contain', 'Description cannot be longer than 500 characters.')
      cy.wait(1000);
    })
  }) 
})